...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-b2nfbfk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-b2nfbfk.containers.anotherwebservice.com/
...
```
git clone git@github.com:codetest754-lang/container-b2nfbfk.git
cd container-b2nfbfk
```
...
```
docker attach container-b2nfbfk
```
